(function() {
  "use strict";
  var Particle, PaticleSystem, Vec2, World, _Object, test,
  ...
  World = (function() {
    function World(canvas) {
      ...
      this.canvasWidth = this.canvas.width = 600;
      ...
      this.canvas.addEventListener("mousewheel", ((function(_this) {
        return function(e) {
          e.preventDefault();
          if (_this.controllable instanceof PaticleSystem) {
            if (e.shiftKey) {
  ...
  _Object = (function() {
    ...
    _Object.prototype.update = function() {
      if (!(this instanceof PaticleSystem)) {
    ...
    _Object.prototype.notVisible = function(threshold) {
      return this.loc.y > this.world.canvasHeight + threshold || this.loc.y < -threshold || this.loc.x > this.world.canvasWidth + threshold || this.loc.y < -threshold;
    };
  ...
  PaticleSystem = (function(superClass) {
    extend(PaticleSystem, superClass);

    function PaticleSystem(config) {
      var ref, ref1, ref2, ref3, ref4;
      PaticleSystem.__super__.constructor.call(this, config);
      this.particles = [];
    ...
    PaticleSystem.prototype.addParticle = function(config) {
      config.system = this;
      config.world = this.world;
      return this.particles.push(new Particle(config));
    };

    PaticleSystem.prototype.removeParticle = function(index) {
      return this.particles.splice(index, 1);
    };

    PaticleSystem.prototype.update = function() {
    ...
    PaticleSystem.prototype.draw = function() {
  ...
  Particle = (function(superClass) {
    ...
    Particle.prototype.draw = function() {
      ...
      grad.addColorStop(0, "rgba(99, 0, 134, .5)");
      grad.addColorStop(.3, "rgba(99, 0, 134, .3)");
